...
def benchmark(
    ...
    results: dict = {"device": device, "seq_len": seq_len}
...
def print_results(results: dict) -> None:
    ...
    print(f"\n### Batch Throughput\n")
    print(f"| Batch Size | Samples/sec |")
    print(f"|------------|-------------|")
...
def main() -> None:
    ...
    results_json["batch_throughput"] = {
        str(k): v for k, v in results["batch_throughput"].items()
    }
